...
var directiveMetadata = []DirectiveMetadata{
	...
	{Name: "resp_map", Block: "response", Hover: "`resp_map <mode>;`\n\nMap non-stream response JSON.", Modes: []string{"openai_responses_to_openai_chat", "anthropic_to_openai_chat", "gemini_to_openai_chat", "gemini_to_openai_images", "minimax_image_to_openai_images", "qwen_image_to_openai_images", "openai_to_anthropic_messages", "openai_to_gemini_chat", "openai_to_gemini_generate_content"}},
